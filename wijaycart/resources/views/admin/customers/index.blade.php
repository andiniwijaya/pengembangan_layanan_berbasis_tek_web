...
@section('content')
    <x-admin.list-filters :action="route('admin.customers.index')" search-placeholder="Cari nama, email, atau telepon..."
        :show-search="true" :status-options="null" :filter-keys="['search']" />

    <p class="mb-4 text-sm text-text/60 dark:text-dark-muted">{{ $customers->total() }} customer</p>
