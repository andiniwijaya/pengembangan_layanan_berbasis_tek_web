    ...
    <div class="card">
        <form action="{{ route('admin.suppliers.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="code" value="{{ old('code', $code) }}" class="input-field font-mono" readonly>
            </div>
            <div>
                <label class="mb-1.5 block text-sm font-medium">Nama Supplier</label>
                <input type="text" name="name" value="{{ old('name') }}" class="input-field @error('name') border-danger @enderror" required>
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="input-field @error('email') border-danger @enderror">
