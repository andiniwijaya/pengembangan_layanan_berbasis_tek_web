...
<div class="mb-6 card !p-4">
    <form action="{{ route('admin.newsletters.index') }}" method="GET" class="flex flex-wrap gap-3">
        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari email..." class="input-field max-w-xs">
...
<x-empty-state icon="newspaper" title="Belum Ada Subscriber" description="Email yang mendaftar newsletter akan muncul di sini." />
@else
        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge {{ $subscriber->is_active ? 'badge-success' : 'badge-danger' }}">{{ $subscriber->is_active ? 'Aktif' : 'Nonaktif' }}</span></td>
