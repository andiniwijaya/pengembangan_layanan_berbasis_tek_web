            ...
            <div class="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="supplier_id" class="input-field">
                        ...
                        <option value="{{ $supplier->id }}" @selected(old('supplier_id') == $supplier->id)>{{ $supplier->code }} — {{ $supplier->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium">Barcode</label>
                    <input type="text" name="barcode" value="{{ old('barcode', $barcode) }}" class="input-field font-mono" readonly>
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium">Harga (Rp)</label>
                    <input type="number" name="price" value="{{ old('price') }}" class="input-field" min="0" required>
                </div>
                <div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="file" name="images[]" accept="image/*" multiple class="input-field" data-image-preview="product-preview">
